...
import './App.css'
import { createOffer, initiateConnection, startCall, sendAnswer, addCandidate, initiateLocalStream, listenToConnectionEvents } from './modules/WebRTCModule'
import firebase from 'firebase/app'
import 'firebase/database'
import config from './config'
import { doOffer, doAnswer, doLogin, doCandidate } from './modules/SignalServerModule'
import 'webrtc-adapter'
import VideoFrontEnd from './VideoFrontEnd'

class VideoBackEndHandler extends React.Component {
  constructor (props) {
    super(props)
    this.state = {
      database: null,
...
export default VideoBackEndHandler
